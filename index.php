                ...
                <div id="register" class="animate form">
                    <form action="php/register.php" autocomplete="on" method="post">
                        ...
                        <p>
                            ...
                            <input min=0  name="housenum" required="required" type="number" placeholder=""/>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <input maxlength="11" minlength="10" name="num" required="required" type="text" placeholder="09** *** ****" pattern="(\+?\d{2}?\s?\d{3}\s?\d{4})|([0]\d{3}\s?\d{3}\s?\d{4})"/>
                        </p>
                        <p>

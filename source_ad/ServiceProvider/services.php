                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="requests">
                                                <table class="table">
                                                    ...
                                                    $ayd = $_SESSION['ayd'];
                                                    $sql = "SELECT DISTINCT service_name FROM services WHERE  sp_id = '$ayd' AND status = 'active'";
                                                    $res = $conn->query($sql);
                                                    ...
                                                    while ($row = $res->fetch_assoc()) {
                                                        ...
                                                        $sql = "SELECT service_id FROM services WHERE service_name = '$p'";
                                                        $n = $conn->query($sql);
                                                        $nn = $n->fetch_row();
                                                        $nnn = $nn[0];
...
<div class="modal fade" id="exampleModal1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="serviceAddForm" action="backend/addService.php" method="post">
                <div class="modal-body ">
                    <div class="card">
                        <div class="card-header card-header-primary text-center">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#addworkBtn').on("click", function () {
            ...
            placeholder="work"></td><td><input required  class="form-control" name="price[]" type="text"
            placeholder="price"></td></tr>`
